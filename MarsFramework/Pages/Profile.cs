...
namespace MarsFramework
{
    internal class Profile
    {
        ...
        #region WebElements for Language tab

        [FindsBy(How = How.XPath, Using = "//a[text() = 'Languages']")]
        private IWebElement LanguagesTab { get; set; }

        [FindsBy(How = How.XPath, Using = "//div[@data-tab = 'first']//div[text() = 'Add New']")]
        private IWebElement AddNewButton { get; set; }

        [FindsBy(How = How.XPath, Using = "//input[@placeholder = 'Add Language']")]
        private IWebElement AddNewLanTextInput { get; set; }

        //Language level - selecting from the drop down
        ...
        private IWebElement ActualMessage { get; set; }


        [FindsBy(How = How.XPath, Using = "//div[@data-tab = 'first' ]//table//tr/td[1]")]
        private IList<IWebElement> LanguagesList { get; set; }
        #endregion
        ...
        internal void clickLanguageTab()
        {
        ...
        internal bool RecordPresent(string language)
        {
            bool matchLang = false;
            foreach (IWebElement lang in LanguagesList)
            {
